...
export class DrawingScene extends AutoDrawScene {
    ...
    navButton: NavButton = new NavButton("navLeft", "right", "");
    ...
    label05: Label = new Label("Label04", "Klicke dazu einfach auf den kleinen Mülleimer.", LEFT, -3.0, {fontsize: 1.0, horizAlign: "left", vertAlign: "center", rotation: 0.0, alpha: 0, color: [0, 0, 0]});

    sprite01: Sprite = new Sprite("Sprite01", "deleteCat.png", 13.9, -1.6, {size: 22.3, imageMode: "center", rotation: 0.0, alpha: 1});
    arrow01: Arrow = new Arrow("arrow01", 13.6, 0.0);
